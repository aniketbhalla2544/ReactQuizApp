...
return (
  ...
  const currentQAModelData = QAModals.find(
    (modal) => currentExerciseNumber === modal.exerciseNumber
  );

  useEffect(() => {
    if (currentQAModelData) {
      setAnswers(currentQAModelData.answers);
    }
    setInputAnswers({});
      ...
      >
        ...
        >
          ...
          <section className='mt-12'>
            ...
            <QAModel
              quesText={currentQAModelData?.quesText ?? 'no ques found!'}
