...
const QAPanel = () => {
  ...
  const previousExerciseNumber = usePrevious(currentExerciseNumber);
  ...
  const QAModals: QAModelsType = useMemo(() => {
    return [
      {
        exerciseNumber: 1,
        quesText:
          ...
          <code className='mb-8 block overflow-x-scroll pb-12 text-lg text-black lg:overflow-x-auto lg:pb-0'>
            ...
            <pre>
                ...
                <input
                  ...
                  name='answerOne'
                  onChange={handleInputTyping}
                  className={`max-w-[6ch] ${canShowAns ? 'font-medium text-rose-700' : 'text-black'
                    } leading-normal`}
                />
                {/* prettier-ignore */}
                {` (props) {`}<br />
          ...
          <code className='mb-8 block overflow-x-scroll pb-8 text-lg leading-[2] text-black lg:overflow-x-auto lg:pb-0'>
            ...
            <pre>
                ...
                <input
                  ...
                  name='answerOne'
                  onChange={handleInputTyping}
                  className={`leading-normal max-w-[5ch] ${canShowAns ? 'font-medium text-rose-700' : 'text-black'
                    }`}
                />
                {`) {`}<br />
                {`    return <h1>Hi, I'm {`}
                <input
                  ...
                  name='answerTwo'
                  onChange={handleInputTyping}
                  className={`max-w-[5ch] ${canShowAns ? 'font-medium text-rose-700' : 'text-black'
                    } leading-normal`}
                />
                {`.name}!</h1>;`}<br />
                {`}`}
  ...
  const memoizedCurrentQAModelData = useMemo(() => {
    return QAModals.find(
      (modal) => currentExerciseNumber === modal.exerciseNumber
    );
  }, [currentExerciseNumber, QAModals]);

  useEffect(() => {
    if (memoizedCurrentQAModelData) {
